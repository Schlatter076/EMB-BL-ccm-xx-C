...
void critical_region_enter(uint32_t *pSr)
{
  *pSr = __get_PRIMASK();
  asm volatile ("cpsid i");
}

void critical_region_exit(uint32_t sr)
{
  __set_PRIMASK(sr);
}
